...
const styles = StyleSheet.create({
  ...
  vendorSub2:    { fontSize: 13, color: '#888', marginTop: 1 },
  inactiveLabel: { fontSize: 13, color: '#e53935', marginTop: 4 },
  ...
  vegNameTe: { fontSize: 13, color: '#666', marginTop: 2 },
  ...
  voiceStatus:   { fontSize: 13, color: '#666', marginTop: 8, lineHeight: 18 },
